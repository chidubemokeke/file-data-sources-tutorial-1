...
export class Contract__clRequestConfigResult {
  value0: Bytes;
  value1: BigInt;
  value2: i32;
  value3: BigInt;
...
export class Contract__claimWindowResult {
  value0: BigInt;
  value1: BigInt;
...
export class Contract extends ethereum.SmartContract {
  ...
  clRequestConfig(): Contract__clRequestConfigResult {
    let result = super.call(
      "clRequestConfig",
    ...
    return new Contract__clRequestConfigResult(
      result[0].toBytes(),
      result[1].toBigInt(),
      result[2].toI32(),
      result[3].toBigInt()
  ...
  try_clRequestConfig(): ethereum.CallResult<Contract__clRequestConfigResult> {
    let result = super.tryCall(
      "clRequestConfig",
      "clRequestConfig():(bytes32,uint64,uint16,uint32)",
      []
    ...
    return ethereum.CallResult.fromValue(
      new Contract__clRequestConfigResult(
        value[0].toBytes(),
        value[1].toBigInt(),
        value[2].toI32(),
        value[3].toBigInt()
  ...
  claimWindow(): Contract__claimWindowResult {
    let result = super.call(
      "claimWindow",
    ...
    return new Contract__claimWindowResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }

  try_claimWindow(): ethereum.CallResult<Contract__claimWindowResult> {
    let result = super.tryCall(
      "claimWindow",
      "claimWindow():(uint128,uint128)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new Contract__claimWindowResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
